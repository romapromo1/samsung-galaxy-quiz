  ...
  return (
    <div className="flex-1 flex flex-col justify-between p-6 md:p-12 w-full h-full bg-white select-none uppercase">
      ...
      <div className="w-full space-y-4">
        ...
        {/* Progress bar: straight corners */}
        <div className="w-full h-4 md:h-5 bg-slate-100 overflow-hidden">
          <div
      ...
      {/* Center Question Card: straight corners */}
      <div className="my-auto py-4 flex items-center justify-center w-full">
        <div className="w-full bg-slate-50 border-2 border-slate-300 p-8 md:p-16 text-center shadow-xs">
      ...
      {/* Answer Options: strictly stacked vertically with straight corners */}
        ...
        {currentQuestion.options.map((option) => {
          ...
          return (
            <button
              ...
              disabled={isLocked}
              className={`w-full min-h-[105px] md:min-h-[135px] lg:min-h-[155px] px-8 md:px-12 py-6 flex items-center gap-8 text-left font-black text-2xl md:text-4xl lg:text-5xl transition-all duration-150 active:scale-98 cursor-pointer ${btnStyle}`}
            >
              <span
                className={`w-18 h-18 md:w-24 md:h-24 flex items-center justify-center font-black text-3xl md:text-5xl lg:text-6xl shrink-0 border border-slate-300 ${
